game.BirdEntity = me.Entity.extend({
    ...
    update: function(dt) {
        ...
        if (me.input.isKeyPressed('fly')) {
            ...
            this.currentAngle += Number.prototype.degToRad(2);
...
game.PipeGenerator = me.Renderable.extend({
    ...
    update: function(dt) {
        if (this.generate++ % this.pipeFrequency == 0) {
            ...
            var lowerPipe = new me.pool.pull('pipe', this.posX, posY);
            var upperPipe = new me.pool.pull('pipe', this.posX, posY2);
            var hitPos = posY - 100;
            var hit = new me.pool.pull("hit", this.posX, hitPos);
            lowerPipe.renderable.currentTransform.scaleY(-1);
            me.game.world.addChild(lowerPipe, 10);
            me.game.world.addChild(upperPipe, 10);
